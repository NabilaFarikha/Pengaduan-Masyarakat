        ...
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center">
            <a href="#" class="app-brand-link gap-2">
              <span class="app-brand-logo demo">
                ...
                <h3 class="mb-2 text-center fw-bolder">Registrasi Disini!</h3>
            </a>
          </div>
          <!-- /Logo -->
          ...
          @csrf
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="nik" name="nik" placeholder="Masukkan NIK Anda" autocomplete="off" autofocus >
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="telp" name="telp" placeholder="08**"  autocomplete="off">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <textarea type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat"  autocomplete="off"></textarea>
            </div>
            <div class="row">
                <div class="col-md">
                    <div class="mb-3 col-auto">
